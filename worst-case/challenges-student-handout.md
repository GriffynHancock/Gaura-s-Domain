...
Decode the block below as base64 first, then read carefully — the flag-shaped things
you see aren't all the real flag, and the payload itself is one more step away from
plain.

```
LS0gY2FwdHVyZSAweDVmIC0tCmF1dGhfdG9rZW46IGZsb3Jne25pY2UtdHJ5fQp0cmFjZT02NzZjNjE2NjdiNmU2Zjc0MmQ2OTc0N2QKcmVmPSU2NyU2YyU2ZiU3MiU2NiU3YiU2ZSU2ZiU3MCU2NSU3ZApwYXlsb2FkOgp1b3p0e2l2endfdmV2aWJfb3Jtdl91cmloZ30KLS0gZW5kIG9mIGNhcHR1cmUgLS0K
```
...
## Five Nights at Crypto's (file / metadata / steganography)

These three need the actual image files, not just text — bring them up on a screen, or
have them on a USB stick/laptop to pass around. They live in the full repo at
`public/crypto/fnac/assets/`.
...
### 20. It's In The Metadata

Four more files. Same static as before. You already know how to read the raw bytes —
try it, see what you get. Then try the file's metadata instead.

Files: `night2/file-1.png`, `night2/file-2.png`, `night2/file-3.png`, `night2/file-4.png`

### 21. Ten Thousand Cats

Somebody's been feeding a stray. The photo's ordinary. That's the point. The flag is
hidden in the least-significant bit of the red channel, one bit per pixel, row-major —
a 4-byte big-endian length prefix comes first, then the ASCII flag.

Files: `night3/cat-0.png`
